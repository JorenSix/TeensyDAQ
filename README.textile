...
p=.!http://0110.be/files/photos/436/slider_TeensyDAQPorts_marked.png!
p=.Fig 1. Ports used from the Teensy
...
p=.!http://0110.be/files/photos/436/slider_teensyDAQ_light_sensor_recording.png!
p=.Screenshot of TeensyDAQ running with live input.

h2. Quickly Getting Started with TeensyDAQ

Head over to the "TeensyDAQ release repository":http://tarsos.0110.be/releases/TeensyDAQ/ and download the latest "TeensyDAQ application":http://tarsos.0110.be/releases/TeensyDAQ/TeensyDAQ-latest/TeensyDAQ-latest.jar. Every "release of TeensyDAQ":http://0110.be/releases/TeensyDAQ/ contains the following:
